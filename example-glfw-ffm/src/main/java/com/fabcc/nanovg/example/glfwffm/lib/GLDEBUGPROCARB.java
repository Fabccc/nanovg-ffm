 ...
 * }
 */
public final class GLDEBUGPROCARB {

    private GLDEBUGPROCARB() {
    ...
    private static final MethodHandle UP$MH = GL.upcallHandle(GLDEBUGPROCARB.Function.class, "apply", $DESC);
