 ...
 * }
 */
public final class GLFWwindowposfun {

    private GLFWwindowposfun() {
    ...
    private static final MethodHandle UP$MH = GLFW.upcallHandle(GLFWwindowposfun.Function.class, "apply", $DESC);
